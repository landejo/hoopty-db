...
POLICY_VERSION = "1.6.0"   # 1.4 = stage model + pursue-next priority (POLICY_CHANGES.md); 1.3 = market fair value, confidence recalibration; 1.1 = guide 1.1 as written; 1.2 = weight/band deviations
