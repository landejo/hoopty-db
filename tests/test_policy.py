...
def test_contradiction_with_tracker_metadata_or_missing_vin_is_not_a_gate():
    ...
    ev.contradictions = [
        Contradiction(topic="engine vs model year", detail="Structured data lists an S54 3.2L, but a 1999 US-market M Roadster is an S52.", severity="identity"),
        Contradiction(topic="M authenticity", detail="Title says M Roadster but nothing in the description, and no VIN, confirms the S engine.", severity="identity"),
    ]
